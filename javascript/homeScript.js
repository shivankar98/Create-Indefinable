...
// uncheck menu checkbox function
...
function pageDown(){
    document.querySelector(".wholePage").style.position="relative";
    document.querySelector(".wholePage").style.top="250px";
    document.querySelector(".wholePage").style.transition="700ms"
}
function pageup(){
    document.querySelector(".wholePage").style.top="0px";
    document.querySelector(".wholePage").style.transition="700ms"
}
...
function potraitThumbnails(){
    ...
    document.getElementById("viewMore").href="portrait.html";
    document.getElementById("viewMore").style.display="block";     // display againwhen craft or digital of product is clicked since they turn the display to hidden
...
function animationThumbnails(){
    ...
    document.getElementById("viewMore").href="animation.html";
...
function abstractThumbnails(){
    ...
    document.getElementById("viewMore").href="abstract.html";
    document.getElementById("viewMore").style.display="block"; 
...
function productThumbnails(){
    ...
    document.getElementById("p7").src="Product/7.jpg";
    document.getElementById("p8").src="Product/8.jpg";
    document.getElementById("p5").style.display="block";
    document.getElementById("p6").style.display="block";
    document.getElementById("p7").style.display="block";
    document.getElementById("p8").style.display="block";
...
function craftThumbnails(){
    ...
    document.getElementById("p7").src="Craft/7.jpg";
    document.getElementById("p8").style.display="none";        
    document.getElementById("p5").style.display="block";
    document.getElementById("p6").style.display="block";
    document.getElementById("p7").style.display="block";
